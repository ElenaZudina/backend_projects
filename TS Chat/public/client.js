(() => {
    ...
    const setStatus = (test, online) => {
        statusPill.textContent = test;
    ...
    // Инициализация: загрузка истории и подключения событий UI
    const init = () => {
        loadHistory();
    ...
    // Запускаме инициализацию, когда DOM готов (скрипт подключен в конце, но на всякий случай)
